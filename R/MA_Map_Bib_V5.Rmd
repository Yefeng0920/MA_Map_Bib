...
#if ggtree not installing use: devtools::install_github("GuangchuangYu/ggtree") and then load manually: library(ggtree)
...
tree.p2 <- tree.p1 %<+% spp.class2 + 
  ...
  xlim_expand(c(0,21), panel = "Tree") + 
  guides(color="none") + scale_color_viridis_d()
...
facet_widths(tree.p3, c(Tree=0.4,`Effect size`=0.2)) #adjust widths of the plot facets for display
```
...
# Part II - Leveraging the Large Language Model to make your figures for other data sets   
